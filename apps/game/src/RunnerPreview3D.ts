...
export async function getRunnerPreviewUrl(
	presetId: string,
	appearance: RunnerAppearance,
): Promise<string> {
 ...
 */
export function renderBusPreview(
	bodyHex: string,
	scoopHex: string,
): Promise<string> {
	const { canvas, engine } = getSharedEngine()
...
export async function getBusPreviewUrl(
	colorId: string,
	bodyHex: string,
	scoopHex: string,
): Promise<string> {
