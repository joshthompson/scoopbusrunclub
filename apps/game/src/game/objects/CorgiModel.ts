...
const ORANGE = new Color3(0.91, 0.6, 0.24) // warm sable/orange
const WHITE = new Color3(0.94, 0.92, 0.88) // warm white
const NOSE_BLACK = new Color3(0.07, 0.07, 0.07)
const EYE_DARK = new Color3(0.16, 0.1, 0.04)
const INNER_EAR = new Color3(0.95, 0.78, 0.7) // pinkish inner-ear
...
export function createCorgiModel(scene: Scene, id: number): RunnerModelResult {
	...
	const blaze = MeshBuilder.CreateBox(
		`cBlaze_${id}`,
		{
			width: 0.07,
			height: blazeH,
	...
	const leftFrontLeg = MeshBuilder.CreateBox(
		`cLFront_${id}`,
		{
			width: LEG_W,
			height: LEG_H,
	...
	const rightFrontLeg = MeshBuilder.CreateBox(
		`cRFront_${id}`,
		{
			width: LEG_W,
			height: LEG_H,
	...
	const leftBackLeg = MeshBuilder.CreateBox(
		`cLBack_${id}`,
		{
			width: LEG_W,
			height: LEG_H,
	...
	const rightBackLeg = MeshBuilder.CreateBox(
		`cRBack_${id}`,
		{
			width: LEG_W,
			height: LEG_H,
