...
export function createHagaGate(
	...
	brickMat.diffuseColor = new Color3(0.76, 0.52, 0.4) // salmon/terracotta
	...
	darkMat.diffuseColor = new Color3(0.12, 0.1, 0.1)
	...
	for (const side of [-1, 1]) {
		...
		barrelMat.diffuseColor = new Color3(0.55, 0.35, 0.2) // wood brown
		...
		flowerMat.diffuseColor = new Color3(0.25, 0.55, 0.2)
