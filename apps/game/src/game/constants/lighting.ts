...
export const LIGHT_NIGHT_HEMI_GROUND_R = 0.1
export const LIGHT_NIGHT_HEMI_GROUND_G = 0.1
...
export const LIGHT_NIGHT_SUN_DIFFUSE_R = 0.2
export const LIGHT_NIGHT_SUN_DIFFUSE_G = 0.2
...
export const LIGHT_NIGHT_TERRAIN_HEMI_GROUND_B = 0.1
