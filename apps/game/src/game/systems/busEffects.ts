 ...
 */
export function createExhaustFlames(
	scene: Scene,
	busMesh: TransformNode,
): ParticleSystem {
 ...
 */
export function createExhaustFlamesForBus(
	scene: Scene,
	busRoot: TransformNode,
): ParticleSystem {
...
export function setWaterWakeActive(
	wake: ParticleSystem[],
...
export function updateWakeIntensity(
	wake: ParticleSystem[],
	active: boolean,
	busSpeed: number,
): void {
 ...
 */
export function createDirtSpray(
	scene: Scene,
	busMesh: TransformNode,
): ParticleSystem[] {
	...
	for (const side of [-1, 1]) {
		...
		// Puff outward and upward from rear tyres
		ps.direction1 = new Vector3(side * 0.6, 0.2, -0.2)
		ps.direction2 = new Vector3(side * 1.2, 0.8, 0.2)
		...
		ps.maxEmitPower = 1.4
		ps.updateSpeed = 0.02
		ps.gravity = new Vector3(0, -0.4, 0) // gentle settle
...
export function setDirtSprayActive(
...
export function updateDirtSprayIntensity(
	spray: ParticleSystem[],
	active: boolean,
	busSpeed: number,
): void {
