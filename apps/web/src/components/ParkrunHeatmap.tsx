				...
				<div class={styles.legend}>
					<span class={styles.legendItem}>
						<span
							...
							style={{ 'background-color': ACTIVITY_COLORS.ran }}
						/>
						Ran
					</span>
					<span class={styles.legendItem}>
						<span
							class={styles.legendSwatch}
							style={{ 'background-color': ACTIVITY_COLORS.volunteered }}
						/>
						Volunteered
					</span>
					<span class={styles.legendItem}>
						<span
							class={styles.legendSwatch}
							style={{ 'background-color': ACTIVITY_COLORS.both }}
						/>
						Both
					</span>
				</div>
				...
				<div class={styles.streaks}>
					...
					<div class={styles.streakStat}>
						...
						<span class={styles.streakLabel}>
							Active{' '}
							<Show when={data().weeks.length > 0} fallback="weeks">
